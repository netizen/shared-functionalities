This is an example application that uses the shared UI components from components package and abstracted functionalities from the abstractions package.
